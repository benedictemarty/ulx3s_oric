...
test-fat-alloc: sim/out
	python3 tools/gen_fat_test.py sim/out/fat_test.img
	iverilog -DSIM -g2005 -o sim/out/tb_fal.vvp sim/tb_fat_alloc.v rtl/fat32.v rtl/sd_spi.v rtl/spi_byte.v sim/sd_card_file.v
